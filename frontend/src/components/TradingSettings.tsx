...
const FIELDS: FieldConfig[] = [
  ...
  {
    key: 'default_spread_width',
    label: 'Spread Width ($)',
    description: 'Width between strikes in spreads',
    type: 'currency',
    min: 1,
    max: 20,
    step: 1,
  ...
  {
    key: 'target_delta_short',
    label: 'Short Strike Delta',
    description: 'Target delta for credit spread short strikes',
    type: 'percent',
    min: 5,
    max: 50,
    step: 1,
  ...
  {
    key: 'credit_profit_target_pct',
    label: 'Credit Profit Target',
    description: '% of max profit to close credit spreads',
    type: 'percent',
    min: 10,
    max: 100,
    step: 5,
  ...
  {
    key: 'max_contracts_per_trade',
    label: 'Max Contracts',
    description: 'Maximum number of contracts per trade',
    type: 'integer',
    min: 1,
    max: 100,
    step: 1,
